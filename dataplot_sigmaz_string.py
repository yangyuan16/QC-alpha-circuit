...
ISsave = True
####得到子图
ax1 = plt.axes([0.09,0.2,0.21,0.6])
ax2 = plt.axes([0.41,0.2,0.21,0.6])
ax3 = plt.axes([0.73,0.2,0.21,0.6])
...
loadexp1 = 'H_heisenberg_sigmazzz_t(%g,%g,%g)_Nq%d_Nc%d_hx%g' % (t1, t2, nt, Nbody, Nbody, hx_fix) + 'exact' + '.pr'
print(loadpath1 + loadexp1)
data_exact = bf.load_pr(loadpath1 + loadexp1)
sigmazzz_exact = data_exact['sigma_zzz']
...
loadexp2 = 'H_heisenberg_sigmazzz_t(%g,%g,%g)_Nq%d_Nc%d_hx%g_dt%g_shots%g' % (t1,t2,nt,Nbody,Nbody,hx_fix,dt,shots) + 'trotter' + '.pr'
print(loadpath2 + loadexp2)
data_trotter = bf.load_pr(loadpath2 + loadexp2)
sigmazzz_trotter = data_trotter['sigma_zzz']
...
loadexp3 = 'H_heisenberg_sigmazzz_thetamax(%g,%g,%g)_Nq%d_Nc%d_hx%g_shots%g' % (theta1,theta2,ntheta,Nbody,Nbody,hx_fix,shots) + 'advance' + '.pr'
print(loadpath3 + loadexp3)
data_advance =  bf.load_pr(loadpath3 + loadexp3)
sigmazzz_advance = data_advance['sigma_zzz']
theta_advance = data_advance['theta_max_range'] * hx_fix



L3_,=ax1_.plot(theta_advance[::4], sigmazzz_advance[::4], label=r'$\alpha$-circuit', ls='--', lw=3, color='blue',
             marker='o', alpha=1, markersize=10, markeredgewidth=1.5, markeredgecolor='blue', markerfacecolor='none')

L1,=ax1.plot(t_range_exact, sigmazzz_exact, label=r'ED', ls='-', lw=5, color='red',
             marker='o', alpha=1, markersize=0, markeredgewidth=1.5, markeredgecolor='red', markerfacecolor='w')

L2,=ax1.plot(t_range_trotter[::4], sigmazzz_trotter[::4], label=r'Trotter', ls='--', lw=3, color='orange',
...
legend1=plt.legend(handles=[L1,L2,L3_], loc = 4, bbox_to_anchor=(0.95, 0.48),ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
...
#=======================================================================================================================
label_x = r't'
label_y = r'$\sigma^{z\otimes 3}(t,h_x)$'
label_x_= r'$\theta$'
...
#==============================================================
ax1.text(0.3,-0.95, r'$\mathrm{(a)}$', fontsize=18)
#ax1.text(0.1,0.9, r'$\mathrm{perplexity = 18}$', fontsize=12)
# ax1.text(0.1,0.8, r'$\mathrm{n_{iter} = 5000}$', fontsize=12)
ax1.text(0.1,-0.45, r'$h_x = 0.5$', fontsize = 16, color='black')
ax1.text(0.1,-0.7, r'$N_q = 3$', fontsize = 16, color='black')
...
ax1.text(8.1,-0.3, r'$\sigma^{z\otimes 3}(\theta)$', fontsize = 16, color='black', rotation = 90)
#=============================================================
# 坐标轴设置第一层
...
# data from exact evolution
loadpath1 = '.\\data\\H_heisenberg_hx\\exact_evolution_fix_hx\\Nbody%g\\'%Nbody
loadexp1 = 'H_heisenberg_zstring_t(%g,%g,%g)_Nq%d_Nc%d_hx%g' % (t1, t2, nt, Nbody, Nbody, hx_fix) + 'exact' + '.pr'
print(loadpath1 + loadexp1)
data_exact = bf.load_pr(loadpath1 + loadexp1)
zstring_exact = data_exact['sigmaz_string']
t_range_exact = data_exact['t_range']
# data from trotter evolution
dt = 0.1; shots = 1024
loadpath2 = '.\\data\\H_heisenberg_hx\\trotter_qasm_simulator_fix_hx\\Nbody%g\\'%Nbody
loadexp2 = 'H_heisenberg_zstring_t(%g,%g,%g)_Nq%d_Nc%d_hx%g_dt%g_shots%g' % (t1,t2,nt,Nbody,Nbody,hx_fix,dt,shots) + 'trotter' + '.pr'
print(loadpath2 + loadexp2)
data_trotter = bf.load_pr(loadpath2 + loadexp2)
zstring_trotter = data_trotter['sigmaz_string']
t_range_trotter = data_trotter['t_range']
# data from advance circuit
theta1 = 0.1; theta2 = 7.9; ntheta = 79
loadpath3 = '.\\data\\H_heisenberg_hx\\advance_qasm_simulator_fix_hx\\Nbody%g\\'%Nbody
loadexp3 = 'H_heisenberg_zstring_thetamax(%g,%g,%g)_Nq%d_Nc%d_hx%g_shots%g' % (theta1,theta2,ntheta,Nbody,Nbody,hx_fix,shots) + 'advance' + '.pr'
print(loadpath3 + loadexp3)
data_advance =  bf.load_pr(loadpath3 + loadexp3)
zstring_advance = data_advance['sigmaz_string']
theta_advance = data_advance['theta_max_range'] * hx_fix

L3_,=ax2_.plot(theta_advance[::4], zstring_advance[::4], label=r'$\alpha$-circuit', ls='--', lw=3, color='blue',
             marker='o', alpha=1, markersize=10, markeredgewidth=1.5, markeredgecolor='blue', markerfacecolor='none')

L1,=ax2.plot(t_range_exact, zstring_exact, label=r'ED', ls='-', lw=5, color='red',
             marker='o', alpha=1, markersize=0, markeredgewidth=1.5, markeredgecolor='red', markerfacecolor='w')

L2,=ax2.plot(t_range_trotter[::4], zstring_trotter[::4], label=r'Trotter', ls='--', lw=3, color='orange',
             marker='o', alpha=1, markersize=10, markeredgewidth=1.5, markeredgecolor='orange', markerfacecolor='w')
...
#=======================================================================================================================
label_x = r't'
label_y = r'$\sigma^{z\otimes 4}(t,h_x)$'
label_x_= r'$\theta$'
...
ax2_.set_xlim([0,4])
ax2_.set_ylim([-0.2,1])
ax2_.set_xticks([0,1,2,3,4])

#==============================================================
ax2.text(0.3,-0.15, r'$\mathrm{(b)}$', fontsize=18)
#ax2.text(0.1,0.9, r'$\mathrm{perplexity = 18}$', fontsize=12)
# ax2.text(0.1,0.8, r'$\mathrm{n_{iter} = 5000}$', fontsize=12)
ax2.text(1,0.8, r'$h_x = 0.5$', fontsize = 16, color='black')
ax2.text(1,0.6, r'$N_q = 4$', fontsize = 16, color='black')
#ax2.text(5.5,0.53, r'Heisenberg', fontsize = 15, color='black')
#ax2.text(5.5,0.5, r'S=1', fontsize = 15, color='black')
#ax2.text(5.5,0.53, r'uniform', fontsize = 15, color='black')
ax2.text(8.1,0.2, r'$\sigma^{z\otimes 4}(\theta)$', fontsize = 16, color='black', rotation = 90)
#=============================================================
# 坐标轴设置第一层
...
ax2_.xaxis.set_major_formatter(FormatStrFormatter('%1.0f'))###设置X轴标签文本格式
...
L3_,=ax3_.plot(theta_advance[::4], zstring_advance[::4], label=r'$\alpha$-circuit', ls='--', lw=3, color='blue',
             marker='o', alpha=1, markersize=10, markeredgewidth=1.5, markeredgecolor='blue', markerfacecolor='none')

L1,=ax3.plot(t_range_exact, zstring_exact, label=r'ED', ls='-', lw=5, color='red',
             marker='o', alpha=1, markersize=0, markeredgewidth=1.5, markeredgecolor='red', markerfacecolor='w')

L2,=ax3.plot(t_range_trotter[::4], zstring_trotter[::4], label=r'Trotter', ls='--', lw=3, color='orange',
             marker='o', alpha=1, markersize=10, markeredgewidth=1.5, markeredgecolor='orange', markerfacecolor='w')

# 画 3 根虚线
L3,=ax3.plot([0,8], [0.5,0.5], label=r'Trotter', ls='--', lw=1, color='grey',
             marker='o', alpha=0.5, markersize=0, markeredgewidth=1.5, markeredgecolor='black', markerfacecolor='w')
L4,=ax3.plot([0,8], [0,0], label=r'Trotter', ls='--', lw=1, color='grey',
             marker='o', alpha=0.5, markersize=0, markeredgewidth=1.5, markeredgecolor='black', markerfacecolor='w')
L5,=ax3.plot([0,8], [-0.5,-0.5], label=r'Trotter', ls='--', lw=1, color='grey',
             marker='o', alpha=0.5, markersize=0, markeredgewidth=1.5, markeredgecolor='black', markerfacecolor='w')
...
ax3_.set_xlim([0,6.4])
ax3_.set_ylim([-1,1])
ax3_.set_xticks([0,1.6,3.2,4.8,6.4])

#==============================================================
ax3.text(0.3,-0.95, r'$\mathrm{(c)}$', fontsize=18)
#ax3.text(0.1,0.9, r'$\mathrm{perplexity = 18}$', fontsize=12)
# ax3.text(0.1,0.8, r'$\mathrm{n_{iter} = 5000}$', fontsize=12)
ax3.text(1,0.7, r'$h_x = 0.8$', fontsize = 16, color='black')
ax3.text(1,0.4, r'$N_q = 5$', fontsize = 16, color='black')
#ax3.text(5.5,0.53, r'Heisenberg', fontsize = 15, color='black')
#ax3.text(5.5,0.5, r'S=1', fontsize = 15, color='black')
#ax3.text(5.5,0.53, r'uniform', fontsize = 15, color='black')
ax3.text(8.1,-0.2, r'$\sigma^{z\otimes 5}(\theta)$', fontsize = 16, color='black', rotation = 90)
#=============================================================
# 坐标轴设置第一层
...
ax3_.xaxis.set_major_formatter(FormatStrFormatter('%1.1f'))###设置X轴标签文本格式
...
ax3_.spines['top'].set_color('blue') ### 设置右边坐标轴的颜色。
ax3_.spines['right'].set_color('blue') ### 设置右边坐标轴的颜色。
#======================================================================
fig.tight_layout()  #自动调整subplot间的参数 !!! feichangzhongyao
#======================================================================
if ISsave:
    fig.savefig(r'.\Figs\fig4.eps',dpi=300, format='eps')
#===================================================
plt.show()